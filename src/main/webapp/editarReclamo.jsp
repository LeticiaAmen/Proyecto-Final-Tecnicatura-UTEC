...
<body>
    ...
    <form action="SvEditarReclamo" method="post" onsubmit="return confirmarEliminacion();">
        ...
        <input type="text" name="titulo" value="${reclamo.tituloReclamo}" required oninvalid="this.setCustomValidity('Por favor, introduce un título entre 3 y 20 caracteres')" oninput="validateLength(this)">
