        ...
        try {
            ...
            if (usuarioLogeado != null) {              
                ...
                if (isAuthenticated) {
                    ...
                    // Crear sesión HTTP y almacenar información del usuario
                    HttpSession session = request.getSession(true);
                    session.setAttribute("userId", usuarioLogeado.getIdUsuario());
                    session.setAttribute("username", usuarioLogeado.getNombreUsuario());
