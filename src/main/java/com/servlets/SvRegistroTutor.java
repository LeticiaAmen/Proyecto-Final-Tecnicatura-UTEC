    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("true".equals(formSubmitted)) {
			...
			if(usuarioService.existeNombreUsuario(nomUsuario)) {
				setErrorAndReturn(request, response, "El nombre de usuario ya existe.", nombre, apellido, documento, nomUsuario, contrasenia, mailInst, mail, telefono, generoSeleccionado, idDepartamento, idLocalidad, idItr, idArea, idRol, fechaNacimientoStr);
				return;
			}
